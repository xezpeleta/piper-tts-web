    ...
    <div class="relative mx-auto flex min-h-screen max-w-6xl flex-col gap-10 px-6 py-12">
      <header class="flex flex-col gap-6">
        ...
        <div class="flex flex-col gap-4">
          ...
          <p class="max-w-2xl text-base text-white/70 sm:text-lg">Generate natural Basque speech with Basque Piper TTS models. Customize the text, pick a voice, then listen or export the audio.</p>
        </div>
